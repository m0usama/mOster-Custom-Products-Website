<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="artPage.aspx.cs" Inherits="mOster_GUI.artPage" %>

<!DOCTYPE html>
<html lang="zxx">
<head>
	<title>mOster | Art Page</title>
	<meta charset="UTF-8">
	<meta name="description" content="mOster | Art Page">
	...
	<script>
        function getid_func(clicked_id) {
            ...
            var temp = document.getElementById("HF6");
...
<body>
	<form runat="server">
		<asp:HiddenField ID="HF6" Value="" runat="server" />
			...
			<div class="row">
                ...
                <ItemTemplate>
						...
						<div class="pi-pic">
							...
							<img src="<%#Eval("art_image_url") %>" alt="" height="505"  width="359">
