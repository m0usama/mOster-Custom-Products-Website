<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="mOster_GUI.Search" %>
...
<head>
	...
	<meta charset="UTF-8">
	<meta name="description" content="mOster | Search">
	...
	<script>
        function getid_func(clicked_id) {
            ...
            var temp = document.getElementById("HF3");
...
<body>
	<form runat="server">
		<asp:HiddenField ID="HF3" Value="" runat="server" />
	...
	<section class="product-filter-section">
		<div class="container">
			...
			<div class="row">
             ...
             <asp:DataList ID="Search_home" runat="server" RepeatColumns="3"  RepeatDirection="Horizontal" OnSelectedIndexChanged="Product_main_SelectedIndexChanged">
                <ItemTemplate>
